...
create index fk_upms_api_category_idx
    on iam_api (category_id);

create index idx_application_id
    on iam_api (application_id, is_deleted);

create table if not exists iam_api_category
(
    id             bigint unsigned auto_increment,
    application_id bigint unsigned default 0                 not null comment '应用id，关联upms_application.id',
...
create index idx_application_id
    on iam_api_category (application_id, is_deleted);
...
create table if not exists iam_permission_role_rel
(
    id            bigint unsigned auto_increment comment 'id'
        primary key,
...
create index idx_pid
    on iam_user_group (pid);

create table if not exists iam_user_group_role_rel
(
    id            bigint unsigned auto_increment comment 'Id'
        primary key,
...
create table if not exists iam_user_group_user_rel
(
    id            bigint unsigned auto_increment comment 'Id'
        primary key,
...
create table if not exists iam_user_role_rel
(
    id           bigint unsigned auto_increment comment 'Id'
        primary key,
