...
CREATE TABLE `iam_menu` (
  ...
  `modifier` bigint unsigned NOT NULL DEFAULT '0' COMMENT '更新人',
  `is_deleted` bigint unsigned NOT NULL DEFAULT '0' COMMENT '删除标识 0-表示未删除 大于0-已删除',
  `path2` varchar(64) NOT NULL DEFAULT '' COMMENT '路由path',
  `component2` varchar(64) NOT NULL DEFAULT '' COMMENT '组件名',
  PRIMARY KEY (`id`,`application_id`),
  UNIQUE KEY `uk_code` (`code`,`is_deleted`),
  UNIQUE KEY `uk_name` (`name`,`is_deleted`),
...
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (2,1,'个人页','account','RouteView',0,'2.',1,'','user',0,1,700,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (3,1,'结果页','result','PageView',0,'3.',1,'','check-circle-o',0,1,500,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','PageView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (4,1,'详情页','profile','RouteView',0,'4.',1,'','profile',0,1,400,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (5,1,'列表页','list','RouteView',0,'5.',1,'','table',0,1,300,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (6,1,'仪表盘','dashboard','RouteView',0,'6.',1,'','dashboard',0,1,100,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (7,1,'异常页','exception','RouteView',0,'7.',1,'','warning',0,1,600,1,'2020-12-24 15:49:19','2020-12-24 15:49:19',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (8,1,'工作台','workplace','Workplace',6,'6.8.',2,'/dashboard/workplace','',0,1,102,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/dashboard/workplace','Workplace');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (9,1,'分析页','Analysis','Analysis',6,'6.9.',2,'/dashboard/analysis/:pageNo([1-9]\\\\d*)?','',0,1,101,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/dashboard/analysis/:pageNo([1-9]\\\\d*)?','Analysis');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (13,1,'查询表格','table-list','TableList',5,'5.13.',2,'/list/table-list/:pageNo([1-9]\\\\d*)?','',0,1,0,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/list/table-list/:pageNo([1-9]\\\\d*)?','TableList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (14,1,'标准列表','basic-list','StandardList',5,'5.14.',2,'/list/basic-list','',0,1,0,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/list/basic-list','StandardList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (15,1,'卡片列表','card','CardList',5,'5.15.',2,'/list/card','',0,1,0,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/list/card','CardList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (16,1,'搜索列表','search','SearchLayout',5,'5.16.',2,'/list/search','',0,1,0,1,'2020-12-24 15:58:43','2020-12-24 15:58:43',0,0,0,'/list/search','SearchLayout');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (17,1,'基础详情页','basic','ProfileBasic',4,'4.17.',2,'/profile/basic','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/profile/basic','ProfileBasic');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (18,1,'高级详情页','advanced','ProfileAdvanced',4,'4.18.',2,'/profile/advanced','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/profile/advanced','ProfileAdvanced');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (19,1,'成功','success','ResultSuccess',3,'3.19.',2,'/result/success','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/result/success','ResultSuccess');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (20,1,'失败','fail','ResultFail',3,'3.20.',2,'/result/fail','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/result/fail','ResultFail');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (22,1,'404','404','Exception404',7,'7.22.',2,'/exception/404','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/exception/404','Exception404');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (23,1,'500','500','Exception500',7,'7.23.',2,'/exception/500','',0,1,0,1,'2020-12-24 16:02:53','2020-12-24 16:02:53',0,0,0,'/exception/500','Exception500');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (24,1,'个人中心Test','center','AccountCenter',2,'2.24.',2,'/account/center','',0,2,0,1,'2020-12-24 16:02:53','2024-08-14 14:32:30',0,1,0,'/account/center','AccountCenter');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (25,1,'个人设置','settings','AccountSettings',2,'2.25.',2,'/account/settings','',1,1,0,1,'2020-12-24 16:02:53','2021-01-04 22:56:19',0,0,0,'/account/settings','AccountSettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (26,1,'搜索列表（项目）','project','SearchProjects',16,'5.16.26.',2,'/list/search/project','',0,1,0,1,'2020-12-24 16:03:23','2020-12-24 16:03:23',0,0,0,'/list/search/project','SearchProjects');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (27,1,'搜索列表（应用）','application','SearchApplications',16,'5.16.27.',2,'/list/search/application','',0,1,0,1,'2020-12-24 16:03:23','2020-12-24 16:03:23',0,0,0,'/list/search/application','SearchApplications');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (28,1,'基本设置','BasicSettings','BasicSettings',25,'2.25.28.',3,'/account/settings/basic','',0,2,0,1,'2020-12-24 16:13:50','2020-12-24 16:13:50',0,0,0,'/account/settings/basic','BasicSettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (29,1,'安全设置','SecuritySettings','SecuritySettings',25,'2.25.29.',3,'/account/settings/security','',0,2,0,1,'2020-12-24 16:13:50','2020-12-24 16:13:50',0,0,0,'/account/settings/security','SecuritySettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (30,1,'个性化设置','CustomSettings','CustomSettings',25,'2.25.30.',3,'/account/settings/custom','',0,2,0,1,'2020-12-24 16:13:50','2020-12-24 16:13:50',0,0,0,'/account/settings/custom','CustomSettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (32,1,'新消息通知','NotificationSettings','NotificationSettings',25,'2.25.32.',3,'/account/settings/notification','',0,2,0,1,'2020-12-24 16:13:50','2020-12-24 16:13:50',0,0,0,'/account/settings/notification','NotificationSettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (34,1,'搜索列表（文章）','article','SearchArticles',16,'5.16.27.',3,'/list/search/article','',0,1,0,1,'2020-12-24 23:55:30','2020-12-24 23:55:30',0,0,0,'/list/search/article','SearchArticles');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (35,1,'其他组件','other','PageView',0,'35.',1,'','slack',0,1,800,1,'2020-12-25 17:23:07','2020-12-25 17:23:07',0,0,0,'','PageView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (36,1,'IconSelector','TestIconSelect','EditList',35,'35.36.',2,'/other/icon-selector','tool',0,1,810,1,'2020-12-25 17:23:15','2020-12-25 17:23:15',0,0,0,'/other/icon-selector','EditList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (37,1,'业务布局','bizLayout','RouteView',35,'35.37.',2,'','layout',0,1,820,1,'2020-12-25 17:23:20','2020-12-25 17:23:20',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (38,1,'树目录表格','TreeList','TreeList',37,'35.37.38.',3,'/other/list/tree-list','',0,1,821,1,'2020-12-25 17:23:24','2020-12-25 17:23:24',0,0,0,'/other/list/tree-list','TreeList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (39,1,'内联编辑表格','EditList','EditList',37,'35.37.39.',3,'/other/list/edit-table','',0,1,822,1,'2020-12-25 17:23:25','2020-12-25 17:23:25',0,0,0,'/other/list/edit-table','EditList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (40,1,'权限列表','PermissionList','PermissionList',37,'35.37.40.',3,'/other/list/system-resourcePermission','',0,1,823,1,'2020-12-25 17:23:25','2021-01-04 22:54:33',0,0,0,'/other/list/system-resourcePermission','PermissionList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (42,1,'角色列表','RoleList','RoleList',37,'35.37.42.',3,'/other/list/role-list','',0,1,825,1,'2020-12-25 17:23:25','2020-12-25 17:23:25',0,0,0,'/other/list/role-list','RoleList');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (43,1,'角色列表2','SystemRole','SystemRole',37,'35.37.43.',3,'/other/list/system-role','',0,1,826,1,'2020-12-25 17:23:25','2020-12-25 17:23:25',0,0,0,'/other/list/system-role','SystemRole');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (44,1,'身份与访问','resourcePermission','RouteView',0,'44.',1,'/iam','slack',0,1,1,1,'2020-12-25 17:41:40','2021-01-02 22:57:31',0,0,0,'/iam','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (45,1,'路由管理','resourcePermission:route','PermissionRoute',44,'44.45.',2,'/resourcePermission/route','',0,2,910,1,'2020-12-25 17:41:45','2021-01-03 16:18:16',0,0,0,'menu','/iam/menu/Menu');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (57,1,'表单页','form','RouteView',0,'57.',1,'','form',0,1,2,1,'2020-12-29 17:17:56','2021-01-03 16:29:31',0,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (58,1,'高级表单','advanced-form','AdvanceForm',57,'57.58.',2,'/form/advanced-form','',0,1,0,1,'2020-12-29 17:19:17','2020-12-29 17:19:17',0,0,0,'/form/advanced-form','AdvanceForm');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (59,1,'分步表单','step-form','StepForm',57,'57.59.',2,'/form/step-form','',0,1,0,1,'2020-12-29 17:20:20','2020-12-29 17:20:20',0,0,0,'/form/step-form','StepForm');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (60,1,'基础表单','basic-form','BasicForm',57,'57.60.',2,'/form/base-form','',0,1,0,1,'2020-12-29 17:21:08','2020-12-29 17:21:08',0,0,0,'/form/base-form','BasicForm');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (70,1,'测试子路由','3213','',69,'6.70.',2,'','',0,1,0,1,'2020-12-30 17:00:33','2020-12-30 17:00:44',0,0,0,'','');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (71,1,'用户管理','resourcePermission:user','PermissionUser',44,'44.71.',2,'user','',0,2,0,1,'2021-01-02 22:57:49','2021-01-02 22:57:49',0,0,0,'user','/iam/user/User');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (72,1,'用户组管理','resourcePermission:usergroup','PermissionUserGroup',44,'44.72.',2,'userGroup','',0,2,0,1,'2021-01-04 22:44:21','2021-01-04 22:44:21',0,0,0,'userGroup','/iam/userGroup/UserGroup');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (73,1,'账号绑定','BindingSettings','BindingSettings',25,'2.25.73.',3,'/account/settings/binding','',0,1,0,1,'2021-01-04 22:57:11','2021-01-04 23:13:44',0,0,0,'/account/settings/binding','BindingSettings');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (74,1,'角色管理','resourcePermission:role','PermissionRole',44,'44.74.',2,'/resourcePermission/role','',0,2,0,1,'2021-01-07 10:33:37','2021-01-07 10:33:37',0,0,0,'role','/iam/user/Role');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (75,1,'应用管理','resourcePermission:application','PermissionApplication',44,'44.75.',2,'/resourcePermission/application','',0,2,0,1,'2021-01-21 10:28:58','2021-01-21 10:28:58',0,0,0,'/resourcePermission/application','PermissionApplication');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (76,1,'接口管理','resourcePermission:interface','PermissionApi',44,'44.76.',2,'/resourcePermission/interface','',0,2,0,1,'2021-01-21 10:29:32','2021-01-21 10:29:32',0,0,0,'/resourcePermission/interface','PermissionApi');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (77,2,'研发效能','cop','RouteView',0,'77.',1,'/cop','project',0,1,0,1,'2021-05-26 13:16:50','2021-05-26 13:16:50',0,0,0,'/cop','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (78,2,'代码工程','cop:code-project','CodeProject',77,'77.78.',2,'/cop/code-project','',0,1,0,1,'2021-05-26 13:23:11','2021-05-26 13:23:11',0,0,0,'/cop/code-project','CodeProject');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1501071145118257154,3,'商品中心','product','RouteView',0,'1501071145118257154.',1,'','slack',0,1,0,1,'2022-03-08 13:43:44','2022-04-18 11:26:50',1,0,0,'','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1501090428636446722,3,'商品分类','product:category','GoodsCategory',1501071145118257154,'1501071145118257154.1501090428636446722.',2,'/goods/category','',0,2,0,1,'2022-03-08 15:00:22','2022-03-08 15:34:58',1,1,0,'/goods/category','GoodsCategory');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1501091482874757122,3,'商品属性','product:attr:template','GoodsAttrTemplate',1501071145118257154,'1501071145118257154.1501091482874757122.',2,'/goods/attr/template','',0,2,0,1,'2022-03-08 15:04:33','2022-04-14 08:16:02',1,0,0,'/goods/attr/template','GoodsAttrTemplate');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1501099262847303682,3,'商品品牌','product:brand','GoodsBrand',1501071145118257154,'1501071145118257154.1501099262847303682.',2,'/goods/brand','',0,2,0,1,'2022-03-08 15:35:28','2022-03-08 15:35:28',1,1,0,'/goods/brand','GoodsBrand');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1507770690745217026,3,'商品属性组','product:attr:group','GoodsAttrGroup',1501071145118257154,'1501071145118257154.1507770690745217026.',2,'/goods/attr/group','',0,3,0,1,'2022-03-27 01:25:20','2022-04-14 07:46:08',1,0,0,'/goods/attr/group','GoodsAttrGroup');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1514538324329037825,3,'商品规格属性','product:attr','GoodsAttr',1501071145118257154,'1501071145118257154.1514538324329037825.',2,'/goods/attr','',0,3,0,1,'2022-04-14 17:37:30','2022-04-14 17:40:59',0,0,0,'/goods/attr','GoodsAttr');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1514907533453660161,3,'132','123','BasicLayout',0,'1514907533453660161.',1,'123','',0,1,0,1,'2022-04-15 18:04:36','2022-04-15 18:04:36',0,0,1514907533453660161,'123','BasicLayout');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1515191685995098114,3,'1','1','404',0,'1515191685995098114.',1,'1','1',0,1,0,1,'2022-04-16 12:54:46','2022-04-16 12:54:50',1,1,1515191685995098114,'1','404');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1515193173177856002,3,'123','31','404',0,'1515193173177856002.',1,'','',0,1,0,1,'2022-04-16 12:59:38','2022-04-16 13:00:03',1,1,1515193173177856002,'','404');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1515894902969925634,3,'商品管理','goods','Goods',1501071145118257154,'1501071145118257154.1515894902969925634.',2,'/goods','',0,2,0,1,'2022-04-18 11:28:03','2022-04-18 11:32:47',0,0,0,'/goods','Goods');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1515899373154271234,3,'商品编辑表单','goodsForm','GoodsForm',1501071145118257154,'1501071145118257154.1515899373154271234.',2,'/goods/form','',0,3,0,1,'2022-04-18 11:45:49','2022-04-18 11:52:31',0,0,0,'/goods/form','GoodsForm');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1557399233418543106,4,'订单中心','order','RouteView',0,'1557399233418543106.',1,'/order','slack',0,1,0,1,'2022-08-11 00:11:27','2022-08-11 00:12:02',0,0,0,'/order','RouteView');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1557401007147761665,4,'订单管理','order:list','Order',1557399233418543106,'1557399233418543106.1557401007147761665.',2,'/order/list','slack',0,2,0,1,'2022-08-11 00:18:30','2022-08-11 00:25:26',0,0,0,'/order/list','Order');
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`, `path2`, `component2`) VALUES (1626224210330099714,4,'订单详情','order:detail','OrderDetail',1557399233418543106,'1557399233418543106.1626224210330099714.',2,'/order/:id','',0,2,0,1,'2023-02-16 22:17:20','2023-02-16 22:17:20',1,1,0,'/order/:id','OrderDetail');
...
CREATE TABLE `iam_user` (
  ...
  KEY `idx_is_deleted` (`is_deleted`)
) ENGINE=InnoDB AUTO_INCREMENT=1797559262702817283 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796092786057752578,'chengmo','18581823821','a734cc2c-7cd5-45fe-8aa1-b6736971b936','$2a$10$WWAZ2AYI0WCD3yxVzk5AuOYzRLEWlaeUc1wS.BjK4ZjpwhJnY0F.i',1,'2024-05-30 16:14:25','2024-05-30 16:14:25',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796107429409009666,'kk','18581823322','00486cc7-605e-4483-914c-b92d7e4a40c3','$2a$10$G.1Rq8uGSyBu7iI/sPfE0uIHtp0mQQEKiWphsEEybegenM5pwhW06',1,'2024-05-30 17:12:36','2024-05-30 17:12:36',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796108036190580738,'xxxsss','18581823329','1f3d11c6-21ac-43ef-9a0c-0fe49f38453f','$2a$10$Ixr1yM5wdLYgPG2/2eyIx.0e9FS5YX67/ToHioCJ9q2NIPcnKUSaK',1,'2024-05-30 17:15:01','2024-05-30 17:15:01',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796116271354163202,'ccccc','18581823388','5b1cf95a-6c40-4c11-b057-e6ec2cf6ee7d','$2a$10$9TbQgo1YG5LkPUe0xSXYbuWJoFfZLo/cifTGjUriZro1Abao.CwxK',1,'2024-05-30 17:47:44','2024-05-30 17:47:44',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796117473684959233,'xxxx','18581823344','f50990c9-0506-488b-8303-8dabc9aff5b8','$2a$10$U/u3qofmwZz61mHlmYDqQ.vnSt8/sOiUVHF/T5QonViTj437JGXZW',1,'2024-05-30 17:52:31','2024-05-30 17:52:31',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796117903836000257,'sssa','18581823328','32f0d862-9977-40e0-b75e-31d74a1e19b2','$2a$10$5nmnkQlLESUFl.h/rMEBS.acF8jHICO9yEBB8m5TXK4e6NbNeAGTC',1,'2024-05-30 17:54:13','2024-05-30 17:54:13',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796118135348998146,'nnn','18581823921','00c114b3-d5d3-4a17-9a4b-5e241dfd63e0','$2a$10$6qZwQwWyztBg6y2e9UwUSu31ydxyfNaWsYlwwSaJUzDmKcxhC.eH2',1,'2024-05-30 17:55:08','2024-05-30 17:55:08',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796118344820928513,'1qq','18581826424','45e620e1-2d2e-4c6a-bce5-677278d20875','$2a$10$4CFaaHkqmUycNMW493wcDO2U6c5NRnd.ENV7OiFMSsh1eNQkizpbu',1,'2024-05-30 17:55:58','2024-05-30 17:55:58',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796118618142748674,'iiii','18581823332','74a2397b-26d2-4ba4-8cae-2d215e0672ac','$2a$10$223b626S/WjJrw3MGEmakujYTnL6pP5ZsaQkb9qTQ7iEgbXpwnDV6',1,'2024-05-30 17:57:03','2024-05-30 17:57:03',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796454927134711809,'okok','12281823332','06864c6b-5eb4-40c1-bd77-7d337b57929d','$2a$10$lww1BLVk/lpJVwsSRx..8.FOuRmcutAqxczpoG533ZKYhdy6XGyd6',1,'2024-05-31 16:13:26','2024-05-31 16:13:26',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1796466532413161474,'cccc','12281822322','00682105-e273-486a-a8a8-b2094e19eff6','$2a$10$J.dNoqUY/2Dp4LGXzBb8b.VaeKJAHsn1fldvF4a07j1h6FWm9XvjC',1,'2024-05-31 16:59:33','2024-05-31 16:59:33',1,1,0);
INSERT INTO `iam_user` (`id`, `username`, `mobile`, `code`, `password`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1797559262702817282,'Jccccc222','12281822872','edd3b3eb-6c8c-4466-bbbe-0a8398f1efea','$2a$10$h0mchwQ4.jz8ToZmiMr6QO7.zP50R1GJucQM05AokVlyFJk5HPXA6',1,'2024-06-03 17:21:40','2024-06-03 17:27:26',1,1,0);
...
CREATE TABLE `iam_user_group` (
  ...
  KEY `idx_is_deleted` (`is_deleted`),
  KEY `idx_pid` (`pid`)
) ENGINE=InnoDB AUTO_INCREMENT=1797552088937193475 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户组表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `iam_user_group` (`id`, `pid`, `name`, `level`, `level_path`, `type`, `inherit_type`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (1797552088937193474,0,'开发',1,'1797552088937193474.',1,0,1,'2024-06-03 16:53:10','2024-06-03 16:53:10',1,1,0);
...
-- Dump completed on 2024-08-27 18:50:05


create table func_tree_node
                                         (
                                             id             bigint unsigned auto_increment comment 'id'
                                                 primary key,
                                             application_id bigint                      default 0                 not null comment '应用id',
                                             biz_id         bigint unsigned             default '0'               not null comment '业务id',
                                             biz_type       varchar(255) charset utf8mb4                          not null comment '业务类型',
                                             parent_biz_id  bigint                      default 0                 not null comment '父级id',
                                             level_path     varchar(45) charset utf8mb4 default ''                not null comment '层级路径，例如：0/1/2 代表该菜单是三级路由，上级路由的id是1,再上级的路由id是0',
                                             level          int                                                   not null comment '层级',
                                             sequence       int                         default 0                 not null comment '排序',
...
insert into func_tree_node(id, application_id, biz_id, biz_type, parent_biz_id,
                           level_path, level, sequence,
                           create_time, update_time, creator, modifier, is_deleted)
select id,
       application_id,
       id,
       'MENU',
