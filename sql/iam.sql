...
INSERT INTO `iam_api` (`id`, `application_id`, `name`, `uri`, `method`, `status`, `category_id`, `auth_type`, `has_path_variable`, `update_time`, `create_time`, `creator`, `modifier`, `is_deleted`) VALUES (22,1,'/iam/v1/role/resourcePermission/menu','/iam/v1/role/resourcePermission/menu','POST',1,3,3,0,'2021-01-26 15:13:19','2021-01-26 15:13:19',0,0,0);
...
INSERT INTO `iam_api` (`id`, `application_id`, `name`, `uri`, `method`, `status`, `category_id`, `auth_type`, `has_path_variable`, `update_time`, `create_time`, `creator`, `modifier`, `is_deleted`) VALUES (24,1,'/iam/v1/role/resourcePermission/menus','/iam/v1/role/resourcePermission/menus','GET',1,3,3,0,'2021-01-26 15:13:19','2021-01-26 15:13:19',0,0,0);
...
INSERT INTO `iam_menu` (`id`, `application_id`, `name`, `code`, `component`, `pid`, `level_path`, `level`, `path`, `icon`, `hide_children`, `type`, `sequence`, `status`, `create_time`, `update_time`, `creator`, `modifier`, `is_deleted`) VALUES (45,1,'路由管理','resourcePermission:menu','PermissionRoute',44,'44.45.',2,'/resourcePermission/menu','',0,2,910,1,'2020-12-25 17:41:45','2021-01-03 16:18:16',0,0,0);
