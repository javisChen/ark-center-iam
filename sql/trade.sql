...
CREATE TABLE `od_cart_item` (
  ...
  `product_name` varchar(64) CHARACTER SET utf8mb3 NOT NULL DEFAULT '' COMMENT '商品名称',
  ...
  `spec_data` varchar(512) CHARACTER SET utf8mb3 NOT NULL DEFAULT '' COMMENT 'SKU销售参数JSON',
...
CREATE TABLE `od_order_item` (
  ...
  `product_name` varchar(64) CHARACTER SET utf8mb3 NOT NULL DEFAULT '' COMMENT '商品名称（冗余）',
  `sku_id` bigint NOT NULL COMMENT 'SKU ID',
  `price` int NOT NULL DEFAULT '0' COMMENT 'SKU单价',
  `quantity` int NOT NULL DEFAULT '0' COMMENT '购买数量',
  `expect_amount` int NOT NULL DEFAULT '0' COMMENT '应付金额',
...
-- Dump completed on 2024-01-08 16:39:46
