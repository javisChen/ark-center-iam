...
drop table if exists nacos_config.config_info_beta;

drop table if exists nacos_config.config_info_tag;

drop table if exists nacos_config.config_tags_relation;

drop table if exists nacos_config.group_capacity;

drop table if exists nacos_config.his_config_info;

drop table if exists nacos_config.permissions;

drop table if exists nacos_config.roles;

drop table if exists nacos_config.tenant_capacity;

drop table if exists nacos_config.tenant_info;

drop table if exists nacos_config.users;

create table if not exists nacos_config.config_info
(
...
create table if not exists nacos_config.config_info_aggr
(
    id           bigint auto_increment comment 'id'
        primary key,
    data_id      varchar(255)            not null comment 'data_id',
...
create table if not exists nacos_config.config_info_beta
(
    id                 bigint auto_increment comment 'id'
        primary key,
    data_id            varchar(255)                           not null comment 'data_id',
...
create table if not exists nacos_config.config_info_tag
(
    id           bigint auto_increment comment 'id'
        primary key,
    data_id      varchar(255)                           not null comment 'data_id',
...
create table if not exists nacos_config.config_tags_relation
(
...
create index idx_tenant_id
    on nacos_config.config_tags_relation (tenant_id);

create table if not exists nacos_config.group_capacity
(
...
create table if not exists nacos_config.his_config_info
(
...
create index idx_did
    on nacos_config.his_config_info (data_id);

create index idx_gmt_create
    on nacos_config.his_config_info (gmt_create);

create index idx_gmt_modified
    on nacos_config.his_config_info (gmt_modified);

create table if not exists nacos_config.permissions
(
...
create table if not exists nacos_config.roles
(
...
create table if not exists nacos_config.tenant_capacity
(
    id                bigint unsigned auto_increment comment '主键ID'
        primary key,
...
create table if not exists nacos_config.tenant_info
(
    id            bigint auto_increment comment 'id'
        primary key,
...
create index idx_tenant_id
    on nacos_config.tenant_info (tenant_id);

create table if not exists nacos_config.users
(
    username varchar(50)  not null
        primary key,
