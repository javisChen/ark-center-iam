...
drop table if exists iam.iam_api;

drop table if exists iam.iam_api_category;

drop table if exists iam.iam_application;

drop table if exists iam.iam_element;

drop table if exists iam.iam_permission;

drop table if exists iam.iam_permission_role_rel;

drop table if exists iam.iam_role;

drop table if exists iam.iam_route;

drop table if exists iam.iam_user;

drop table if exists iam.iam_user_group;

drop table if exists iam.iam_user_group_role_rel;

drop table if exists iam.iam_user_group_user_rel;

drop table if exists iam.iam_user_role_rel;
...
(
    ...
    uri               varchar(128)     default ''                not null comment '接口地址',
...
create index idx_application_id
    on iam.iam_api_category (application_id);
...
(
    id             bigint unsigned auto_increment comment 'id'
        primary key,
    application_id bigint           default 1                 not null comment '应用id',
...
create index idx_role_id_permission_id
    on iam.iam_permission_role_rel (role_id, permission_id);
